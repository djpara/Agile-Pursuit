...
public class GlobalVariables {
	...
	public static final Color T_COLOR				= new Color( 255, 252,  56 );
	public static final Color L_COLOR				= new Color( 126,  20, 127 );
	public static final Color J_COLOR				= new Color(   0,  44, 250 );
